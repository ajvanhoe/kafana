<nav id="primary-menu" class="style-5">
    ...
    <ul class="norightborder norightpadding norightmargin">
        ...
        <li><a href="{{route('menu')}}" target="__blank"><div><i class="icon-file-alt"></i>@lang('content.menu_menu')</div></a></li>
        <li><a href="#gallery"><div><i class="icon-picture"></i>@lang('content.menu_gallery')</div></a></li>
        <!-- <li><a href="#"><div><i class="icon-pencil2"></i>@lang('content.menu_blog')</div></a></li> -->
        <li><a href="#footer"><div><i class="icon-map-marker2"></i>@lang('content.menu_contact')</div></a></li>
